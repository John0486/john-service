  ...
  return (
    <>
      ...
      <div className="w-[100%] flex flex-col flex-nowrap items-center justify-center gap-7 px-mobileBound sm:px-8 sm:gap-8 md:gap-9 lg:gap-10">
        <p className="text-justify mx-auto sm:mt-5 lg:mt-6">
          If you&apos;re interested in exploring a comprehensive list of my
          skills and experience, I invite you to check out my{" "}
          <Link className="inline-link" to="/resume">
            resume
          </Link>
          .
        </p>
