...
export const projects = [
  {
    ...
    ariaLabel:
      "Opens modal window with more information about the MindFit Mental Health web project",
    details: {
      description:
        "MindFit Mental Health is located in East Atlanta, New York. They provide strength-based individual and group mental health counseling services. They use cutting edge technology to help young people learn and practice skills in self-regulation, mindfulness, and positive thinking.",
      technologies: [
        {
          title: "HTML",
          Icon: Icons.HtmlIcon,
...
export const socialMedias = [
  {
    ...
    ariaLabel: "Compose an email to John",
    title: "Write an Email to John",
    Icon: Icons.EmailIcon,
  },
  {
    href: "https://github.com/John0486",
    ariaLabel: "Goes to John&apos;s GitHub profile",
